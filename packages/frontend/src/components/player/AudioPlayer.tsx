    ...
    <>
      ...
      {expanded && (
        <div className="fixed inset-0 z-200 bg-black/50 flex items-end justify-center animate-fade-in md:items-center" onClick={() => setExpanded(false)}>
          <div className="bg-surface rounded-t-[20px] w-full max-w-[480px] max-h-[80vh] overflow-y-auto px-6 pt-4 pb-10 animate-slide-up md:rounded-2xl md:max-h-[85vh] md:shadow-[0_24px_48px_rgba(0,0,0,0.3)] md:animate-scale-in max-sm:max-w-full max-sm:px-4 max-sm:pb-8 max-sm:pt-3" onClick={(e) => e.stopPropagation()}>
